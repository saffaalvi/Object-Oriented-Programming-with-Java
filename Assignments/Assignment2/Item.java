/**base class
 * This class is a parent class for the Book, GiftCard, and Shoe classes.
 * It sets the value of id, price, quantity, and Title, making sure inputs are valid
 * Abstract class as it contains method for child classes to implement (Display())
